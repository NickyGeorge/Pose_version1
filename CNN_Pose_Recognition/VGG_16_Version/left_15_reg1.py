...
image_lt_15 = np.zeros((200, 224, 224, 1))
image_lt_15 = left_151.Collect_Pic()
image_ff = front_face1.Collect_Pic()
#print(image_lt_15[8])
#print(len(image_ff))
#print(len(image_lt_15))
#print(image_lt_15.shape)
#print(image_ff.shape)
np_example_lt_15 = np.zeros((batch_size,224,224,1))
...
with tf.Session() as sess:
    ...
    #np.savetxt('E:\Pycharmworfspace\Pose_version1\CNN_Pose_Recognition\VGG_16_Version\Results\letf_15_reg_results.txt',results_1)
